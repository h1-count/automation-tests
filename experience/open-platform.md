...
- 已完成：登录与注册（`testpacks/web/open-platform/login-register/`，25 条用例全量通过；2026-09-02 对象矩阵核对新增绕过直达 022、注册协议未勾选 023，凭据初始化轮新增 024 重置链路设置测试账号密码、025 账号密码登录成功路径含首次设备验证短信分支）；创建产品（`testpacks/web/open-platform/create-product/`，2026-09-02 对象矩阵核对后 13 条用例全量验证通过：新增重复产品名称 013、003/005/008 补核对步骤，2026-09-10 复测 13/13 通过，详见其 conclusion.md）。
