# 测试设计索引：开放平台登录、注册及相关功能与产品创建完整测试
...
| 项目 | 内容 |
| --- | --- |
| 测试请求 | web/open-platform/login-register-product-full-20260817-2 |
| 测试类型 | Web |
| 目标环境 | test |
| 数据策略 | no_write |
...
- 测试开放平台登录、注册及其资料定义的相关功能，以及产品创建功能；完整范围、来源和执行边界将在来源选择后固化。
...
| --- | --- | --- | --- |
| 用户 | delivery-target | full_run | 用户要求测试开放平台登录注册及其相关功能与产品创建；业务写入仍需独立执行授权。 |
